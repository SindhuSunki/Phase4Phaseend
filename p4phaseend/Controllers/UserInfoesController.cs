...
using p4phaseend.Models;

namespace p4phaseend.Controllers
{
    public class UserInfoesController : Controller
    {
        private readonly S10phaseendContext _context;

        public UserInfoesController(S10phaseendContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.UserInfos != null ? 
                          ...
                          Problem("Entity set 'S10phaseendContext.UserInfos'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'S10phaseendContext.UserInfos'  is null.");
            }
            var userInfo = await _context.UserInfos.FindAsync(id);
            if (userInfo != null)
            {
